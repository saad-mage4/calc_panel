...
<aside class="main-sidebar sidebar-dark-primary elevation-4 d-lg-none">
    <!-- Brand Logo -->
    <a href="index3.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">MPC</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block"><?= (is_loggedin()) ? $username:'Guest' ?></a>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="<?= site_url ?>?guest=yes" class="nav-link active">
